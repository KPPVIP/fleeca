...
Strings = {
    ['wait_nextheist'] = 'Vous devez attendre pour braquer',
    ['minute'] = 'minute.',
    ['need_item'] = 'Vous avez besoin de ceci : ',
    ['police_alert'] = 'Alerte vol de banque Fleeca ! Vérifiez votre GPS.',
    ['drill'] = 'Appuyez sur ~INPUT_CONTEXT~ pour utiliser la perceuse',
    ['grab_trolly'] = 'Appuyez sur ~INPUT_CONTEXT~ pour saisir',
